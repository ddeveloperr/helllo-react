...
/***/ (function(module, exports, __webpack_require__) {
	...
	var firstName = 'Kemal';
	var myMessage = "I'm so happy to learn React.js so fast!";

	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: myMessage }), document.getElementById('app'));
